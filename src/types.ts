...
export interface AuthRepository {
  findUserByEmail(email: string): Promise<{ id: string; email: string; name: string; role: string; org_id: string; password_hash: string } | null>
  createOrg(id: string, name: string): Promise<void>
  createUser(id: string, orgId: string, name: string, email: string, passwordHash: string, role: string): Promise<void>
